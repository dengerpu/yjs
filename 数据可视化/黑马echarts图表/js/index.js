...
(function () {
    ...
    // 点击tab栏切换
    var btns = document.querySelectorAll('.line a')
...
(function(){
    ...
    var XNData = [
        [{name:'西宁'}, {name:'贵阳',value:100}],
        [{name:'西宁'}, {name:'沈阳',value:100}],
        [{name:'西宁'}, {name:'深圳',value:100}],
        [{name:'西宁'}, {name:'拉萨',value:100}],
        [{name:'重庆'}, {name:'郑州',value:100}]
    ];
