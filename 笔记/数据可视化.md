...
- 设计稿是1920px  
  ...
  2. cssrem 插件的基准值是  80px 
     ...
     ![image-20220710151512684](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710151512684.png)
...
![image-20220710175917416](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710175917416.png)

图表提示框组件：tooltip

![image-20220710180055466](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710180055466.png)
...
![image-20220710180210683](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710180210683.png)

工具箱组件：toolbox

![image-20220710180341245](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710180341245.png)

网格配置：grid 

可以控制线形图，柱状图，图表大小

![image-20220710181016693](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710181016693.png)

x轴，y轴配置：xAxis,yAxis

![image-20220710181351609](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710181351609.png)

系列图表配置：series

，决定显示哪种类型的图标

![image-20220710182140289](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710182140289.png)

颜色配置：color（是一个数组）

![image-20220710182647893](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710182647893.png)

![image-20220710182434472](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220710182434472.png)
  ...
  series: [
    {
      name: 'Email',
      type: 'line',
      stack: 'Total', //值相同会造成数据积累，例如1是120,2是220但其实2显示的是120+220
      data: [120, 132, 101, 134, 90, 230, 210]
    },
    {
      name: 'Union Ads',
...
![image-20220723193442991](https://trpora-1300527744.cos.ap-chongqing.myqcloud.com/img/image-20220723193442991.png)
        ...
        xAxis: [
          {
            ...
            axisLine: {
              symbol: ["none", "arrow"],  //箭头做法
              symbolOffset: [0, 22],   //箭头做法
              symbolSize:[15,15],
              show: true, // x轴线
              lineStyle: {
                // x轴样式
        ...
        series: [
          {
            ...
            data: [18.24, 15.58, 24.75, 8.0, 8.0],
          },
          {
            name: "班级平均分",
            type: "line",
